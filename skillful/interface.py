...
class ValidateArgsMixin(object):
    """Argument validation mixin class"""
    def _validate_args(self, default_args, **kwargs):
        # TODO: assert only valid args exist
        # set args
        for arg, val in six.iteritems(default_args):
            setattr(self, arg, kwargs.get(arg, val))

class Body(ValidateArgsMixin):
...
class BodyChild(ValidateArgsMixin):
...
class RequestBody(Body):
    ...
    def __init__(self, **kwargs):
        ...
        default_args = dict(version=str(),
                            session=Session(),
                            request=Request())
        self._validate_args(default_args, **kwargs)
...
class Application(BodyChild):
    ...
    def __init__(self, **kwargs):
        ...
        default_args = dict(application_id=None)
        self._validate_args(default_args, **kwargs)
...
class IntentRequest(Request):
    ...
    def __init__(self, **kwargs):
        ...
        default_args = dict(intent=Intent())
        self._validate_args(default_args, **kwargs)
...
class Response(BodyChild):
    ...
    def __init__(self, **kwargs):
        ...
        default_args = dict(output_speech=OutputSpeech(),
                            card=Card(),
                            reprompt=Reprompt(),
...
class Image(BodyChild):
    ...
    def __init__(self, **kwargs):
        ...
        default_args = dict(small_image_url=str(),
                            large_image_url=str())
        self._validate_args(default_args, **kwargs)
